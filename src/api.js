...
export const api = {
  ...
  mlPromoRemoverItem: (itemId, tipo, pid) => req(`/api/mercadolivre/promocoes/item/${encodeURIComponent(itemId)}?promotion_type=${encodeURIComponent(tipo)}${pid ? `&promotion_id=${encodeURIComponent(pid)}` : ''}`, { method: 'DELETE' }),
